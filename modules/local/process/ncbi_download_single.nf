...
// // Download genomes using NCBI datasets CLI given a taxid
// process NCBI_DOWNLOAD_SINGLE {
//     tag "TaxID: ${taxid}"
//     label "process_medium"
...
//     # Extract accessions based on the mode-specific limit
//     datasets summary genome taxon ${taxid} \$TOGGLE --report sequence --as-json-lines > genome_summary.jsonl
//     dataformat tsv genome-seq --inputfile genome_summary.jsonl --fields accession > all_accessions.tsv
//     tail -n +2 all_accessions.tsv | uniq > tmp_all.tsv
//     head -n ${n_genomes} tmp_all.tsv > accessions.txt
...
//     if [ ! -s accessions.txt ]; then
//       echo "Error: No accessions found."
//       exit 1
//     fi
