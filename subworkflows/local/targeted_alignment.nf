...
include { NCBI_DOWNLOAD_SINGLE as NCBI_DOWNLOAD_INDICATOR    } from '../../modules/local/process/ncbi/downloadsingle/main'
include { CONCATENATE_PATHOGEN_INDICATOR_GENOMES             } from '../../modules/local/process/concatenate_pathogen_indicator_genomes/main'
include { NCBI_DOWNLOAD_BATCH    } from '../../modules/local/process/ncbi/downloadbatch/main'
include { BUILD_PATHOGEN_DB      } from '../../modules/local/process/build_pathogen_db/main'
include { MINIMAP2_INDEX as MINIMAP2_INDEX_SINGLE       } from '../../modules/local/process/minimap2/index/main'
include { MINIMAP2_ALIGN as MINIMAP2_ALIGN_SINGLE       } from '../../modules/local/process/minimap2/align/main'
include { COMPUTE_PATHOGEN_METRICS as COMPUTE_PATHOGEN_METRICS_SINGLE   } from '../../modules/local/process/compute_pathogen_metrics/main'
include { GET_PATHOGEN_REFERENCE } from '../../modules/local/process/get_pathogen_reference/main'
include { GENERATE_REPORT        } from '../../modules/local/process/generate_report/main'
...
include { SAMTOOLS_FAIDX as SAMTOOLS_FAIDX_TARGET       } from '../../modules/local/process/samtools/faidx/main'
include { LOFREQ_INDELQUAL } from '../../modules/nf-core/lofreq/indelqual'
include { SAMTOOLS_INDEX as SAMTOOLS_INDEX_INDELQUAL       } from '../../modules/local/process/samtools/index/main'
include { LOFREQ_VITERBI } from '../../modules/nf-core/lofreq/viterbi'
include { SAMTOOLS_INDEX as SAMTOOLS_INDEX_VITERBI       } from '../../modules/local/process/samtools/index/main'
// include { LOFREQ_ALNQUAL } from '../../modules/nf-core/lofreq/alnqual'
// include { SAMTOOLS_INDEX as SAMTOOLS_INDEX_ALNQUAL       } from '../../modules/local/process/samtools/index/main'
include { LOFREQ_CALLPARALLEL } from '../../modules/local/process/lofreq/callparallel/main'
include { LOFREQ_FILTER       } from '../../modules/local/process/lofreq/filter/main'
include { REHEADER_VCF        } from '../../modules/local/process/reheader_vcf/main'
include { CALCULATE_DIVERSITY } from '../../modules/local/process/calculate_diversity/main'
